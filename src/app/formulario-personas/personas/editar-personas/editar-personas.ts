...
@Component({
  ...
  imports: [MatButtonModule, MatFormFieldModule, ReactiveFormsModule, MatInputModule, FormsModule, SelectorMultiple, MatDatepickerModule, EditarCorreos, EditarDirreciones, EditarTelefonos],
